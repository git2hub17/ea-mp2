...
clone the source code from GitHub link:
 [GitHub](https://github.com/git2hub17/ea-eCommerce) (ask us about accessing to git repository or use our provided source code)
